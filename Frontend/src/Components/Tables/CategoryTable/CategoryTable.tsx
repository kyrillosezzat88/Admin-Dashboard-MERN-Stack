...
import { DeleteProductCategoryAction } from "../../../Context/Actions/ProductActions/ProductActions";

function CategoryTable({ data }: CategoryTableProp) {
  const { categoryDispatch, productDispatch, authDispatch, category }: any =
    useDashboard();
    ...
    if (selectedCategory) {
      ...
      await DeleteCategoryApi(selectedCategory._id)
        .then((res) => {
          ...
          productDispatch(DeleteProductCategoryAction(selectedCategory._id));
